...
//     while ((s_position = str.find(" ", s_position))!= std::string::npos || (c_position = str.find(":", c_position)!= std::string::npos))
//     {
        
//         // PING : poiu asdf poiu
//         // std::cout << "start : " << start << std::endl;
//         std::cout << "c_pos : " << c_position << std::endl;
//         std::cout << "s_pos : " << s_position << std::endl;
//         std::string temp = "";
//     //    std::cout << "this! : " << position << std::endl;
//         if (c_position)
//         {
//             for (size_t i = c_position + 1; i < str.length(); i++)
//             {
//                 temp += str[i];
//             }
//             v.push_back(temp);
